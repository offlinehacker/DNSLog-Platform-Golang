...
func checkdir() {
	localdir, _ := os.Getwd()
	tmplogdir = localdir + string(os.PathSeparator)+"dnslog"+string(os.PathSeparator)
	if !Exists(tmplogdir) {
